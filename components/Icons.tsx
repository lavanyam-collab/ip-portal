...
// The specific Interior Plus Brand Logo
export const InteriorPlusLogo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 180" fill="none" className={className}>
    <g transform="translate(0, 20)">
      <rect x="0" y="0" width="32" height="28" fill="#DC2626" /> 
      <rect x="0" y="28" width="32" height="28" fill="#F97316" /> 
      <rect x="0" y="56" width="32" height="28" fill="#F59E0B" /> 
      <rect x="0" y="84" width="32" height="28" fill="#10B981" /> 
    </g>
    <text x="55" y="115" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="58" fill="#1F2937" letterSpacing="-2">
      NTERIOR
    </text>
    <g transform="translate(0, 5)">
        <rect x="55" y="125" width="66" height="10" fill="#10B981" /> 
        <rect x="125" y="125" width="66" height="10" fill="#F59E0B" /> 
        <rect x="195" y="125" width="66" height="10" fill="#F97316" /> 
        <rect x="265" y="125" width="66" height="10" fill="#DC2626" /> 
    </g>
    <text x="331" y="175" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="36" fill="#1F2937" textAnchor="end">
      PLUS
    </text>
  </svg>
);
...
export const LogoIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 160" fill="none" className={className}>
    <g transform="translate(10, 10)">
      <path d="M0 0 H32 V30 H0 Z" fill="#DC2626" />
      <path d="M0 35 H32 V65 H0 Z" fill="#F97316" />
      <path d="M0 70 H32 V100 H0 Z" fill="#F59E0B" />
      <path d="M0 105 H32 V135 H0 Z" fill="#10B981" />
    </g>
  </svg>
);
...
export const FaceIdIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M8 3a8.99 8.99 0 0 1 8 0" /><path d="M19.07 4.93a10 10 0 0 1 1.96 4.4" /><path d="M21.03 14.67a10 10 0 0 1-1.96 4.4" /><path d="M16 21a8.99 8.99 0 0 1-8 0" /><path d="M4.93 19.07a10 10 0 0 1-1.96-4.4" /><path d="M2.97 9.33a10 10 0 0 1 1.96-4.4" /><path d="M9 10a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1Z" /><path d="M15 10a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1Z" />
  </svg>
);

export const FingerprintIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6" /><path d="M5 16v-3a7 7 0 0 1 14 0v3" /><path d="M8 12a4 4 0 0 1 8 0v4" /><path d="M12 12v3" /><path d="M12 22c-3 0-6-1.5-6-4" /><path d="M15 19a3 3 0 0 1 4-1" />
  </svg>
);
...
export const LifeBuoyIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="4" /><line x1="4.93" x2="9.17" y1="4.93" y2="9.17" /><line x1="14.83" x2="19.07" y1="14.83" y2="19.07" /><line x1="14.83" x2="19.07" y1="9.17" y2="4.93" /><line x1="14.83" x2="9.17" y1="9.17" y2="14.83" /><line x1="4.93" x2="9.17" y1="19.07" y2="14.83" />
  </svg>
);
...
export const CurrencyIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    {/* Rupee Symbol */}
    <path d="M6 3h12M6 8h12M6 13h5l4 8M6 13h12" />
  </svg>
);
...
export const BankIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 21h18"/><path d="M5 21v-7"/><path d="M19 21v-7"/><path d="M10 21v-7"/><path d="M14 21v-7"/><path d="M2 10h20"/><path d="M12 2 2 7l10 5 10-5-10-5z"/>
  </svg>
);

export const IdCardIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="18" height="14" x="3" y="5" rx="2"/><circle cx="9" cy="9" r="2"/><path d="M15 8h2"/><path d="M15 12h2"/><path d="M7 16h10"/>
  </svg>
);
...
export const ReceiptIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>
  </svg>
);
...
export const SimCardIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M6 2h10l4 4v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z"/><path d="M10 20h4"/><path d="M12 15v5"/><path d="M9 15h6"/><path d="M9 12h6"/><path d="M9 9h6"/>
  </svg>
);
